...
namespace WebApp.App_Start
{
    public class EmailService : IIdentityMessageService
    {
        ...
        private const string EmailFromAddress = "habibah@live.com";
        private const string EmailFromName = "Notes";

        public EmailService()
        {
            _mandrill = new MandrillApi(ConfigurationManager.AppSettings["bS3V2Q-hNAvq_p4zmaS5Pw"]);
        }
        ...
        internal Task SendWelcomeEmail(string p1, object p2)
        {
